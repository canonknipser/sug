...
/**
 * Simple User Gallery Notification class.
 */
class demo extends \phpbb\notification\type\base
{
	...
	{
		return 'canonknipser.sug.notification.type.demo';
	}
	...
	{
		return $this->helper->route('canonknipser_sug_controller', $this->get_data('acme_demo'));
	}
